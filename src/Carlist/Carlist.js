...
function Carlist() {
  ...
  return (
    ...
    <section className="featured section" id='featured'>
        <h2 className="ss section__title" data-aos="zoom-in" style={{fontSize:"35px"}}>
            Discover <span style={{color:"rgb(0, 255, 128)"}}>M</span>ore<span style={{color:"rgb(0, 255, 128)"}}> </span>
        </h2>
            ...
            <div className="featured__content grid" >
                ...
                <article className="featured__card mix hun" >
                    <div className="shape shape__smaller"></div>
                        ...
                        <h3 className="featured__price">₹ 2,000 (Base Fair)</h3>
                ...
                <article className="featured__card mix suzuki " >
                    <div className="shape shape__smaller"></div>
                        ...
                        <h3 className="featured__price">₹ 1,900 (Base Fair)</h3>
                        <button className="button featured__button">
                        <i className="ri-heart-fill"></i>
                        </button>
                </article>
                ...
                <article className="featured__card mix tata" >
                    <div className="shape shape__smaller"></div>
                        ...
                        <h3 className="featured__price">₹ 1,800 (Base Fair)</h3>
                        <button className="button featured__button">
                        <i className="ri-heart-fill"></i>
                        </button>
                </article>
                ...
                <article className="featured__card mix mahindra" >
                    <div className="shape shape__smaller"></div>
                        ...
                        <h3 className="featured__price">₹ 2,500 (Base Fair)</h3>
                        <button className="button featured__button">
                        <i className="ri-heart-fill"></i>
                        </button>
                </article>
